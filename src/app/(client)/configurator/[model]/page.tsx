...
export default function ConfiguratorPage() {
  ...
  // Kick off GLTF download immediately — runs in parallel with CarScene JS bundle load
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-toyota-dark">
      ...
      {process.env.NODE_ENV === "development" && (
        <div className="fixed top-2 left-2 z-50 bg-black/90 text-green-400 text-xs font-mono p-2 rounded pointer-events-none max-w-xs overflow-hidden">
          <div>Model: {getModelPath(vehicle.id)}</div>
