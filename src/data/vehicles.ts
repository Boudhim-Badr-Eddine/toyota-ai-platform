...
export const VEHICLES_DATA: Vehicle[] = [
  // ── 1. Toyota Supra ────────────────────────────────────────────────────────
  {
    ...
    name: "Toyota Supra",
    category: "Sport",
    model3dPath: "/models/supra/scene.gltf",
    imageUrl: "/images/vehicles/supra.jpg",
    images: [
      "/images/vehicles/supra.jpg",
      "/images/vehicles/supra-rear.jpg",
      "/images/vehicles/supra-interior.jpg",
    ],
    ...
    description:
      "La Toyota Supra représente l'apogée du sport automobile japonais. Avec son moteur turbo 6 cylindres de 340 ch développé en partenariat avec BMW, elle offre une expérience de conduite pure et adrénalinique.",
  },
  ...
  // ── 2. Toyota RAV4 ─────────────────────────────────────────────────────────
  {
    ...
    model3dPath: "/models/rav4/scene.gltf",
    ...
    description:
      "Le RAV4 hybride est le SUV familial par excellence. Spacieux, économique et polyvalent, il s'adapte parfaitement à tous les styles de vie marocains.",
  },
  ...
  // ── 3. Toyota Yaris ────────────────────────────────────────────────────────
  {
    ...
    name: "Toyota Yaris",
    category: "Citadine",
    model3dPath: "/models/yaris/scene.gltf",
    ...
    description:
      "La Yaris hybride est la citadine intelligente par excellence. Compacte, agile et ultra-économique, parfaite pour naviguer dans les villes marocaines.",
  },
  ...
  // ── 4. Toyota Corolla ──────────────────────────────────────────────────────
  {
    ...
    model3dPath: "/models/corolla/scene.gltf",
    ...
    description:
      "La Corolla hybride incarne la fiabilité Toyota réinventée. Élégante et technologique, elle offre le parfait équilibre entre confort quotidien et conscience écologique.",
  },
  ...
  // ── 5. Toyota Camry ────────────────────────────────────────────────────────
  {
    ...
    model3dPath: "/models/camry/scene.gltf",
    ...
    description:
      "La Camry hybride redéfinit la berline de confort. Silencieuse, spacieuse et luxueuse pour les longs trajets.",
  },
  ...
  // ── 6. Toyota Land Cruiser ─────────────────────────────────────────────────
  {
    ...
    model3dPath: "/models/landcruiser/scene.gltf",
    ...
    description:
      "Le Land Cruiser est une légende tout-terrain indestructible. Son V6 biturbo diesel de 700 Nm et sa transmission 4WD intégrale le rendent imbattable en hors-piste saharien.",
  },
  ...
  // ── 7. Toyota Hilux ────────────────────────────────────────────────────────
  {
    ...
    model3dPath: "/models/hilux/scene.gltf",
    ...
    description:
      "Le Hilux est le pick-up le plus vendu au monde depuis plus de 50 ans. Robuste, fiable et polyvalent, indispensable pour les professionnels et aventuriers marocains.",
  },
  ...
  // ── 8. Toyota Prius ────────────────────────────────────────────────────────
  {
    ...
    name: "Toyota Prius",
    category: "Éco/Tech",
    model3dPath: "/models/prius/scene.gltf",
    ...
    description:
      "La Prius PHEV révolutionne la mobilité éco-responsable avec jusqu'à 80 km en mode 100% électrique.",
  },
  ...
  // ── 9. Toyota C-HR ─────────────────────────────────────────────────────────
  {
    ...
    name: "Toyota C-HR",
    category: "SUV Urbain",
    model3dPath: "/models/chr/scene.gltf",
    ...
    description:
      "Le C-HR hybride s'impose comme le SUV urbain le plus audacieux avec son design coupé unique.",
  },
  ...
  // ── 10. Toyota Highlander ──────────────────────────────────────────────────
  {
    ...
    model3dPath: "/models/highlander/scene.gltf",
    ...
    description:
      "Le Highlander hybride est le SUV 7 places par excellence. Grand, luxueux et économique pour les grandes familles marocaines.",
  },
  ...
  // ── 11. Toyota Granvia ─────────────────────────────────────────────────────
  {
    ...
    imageUrl: "/images/vehicles/granvia.jpg",
    images: [
      "/images/vehicles/granvia.jpg",
      "/images/vehicles/granvia.jpg",
    ],
  ...
  // ── 12. Toyota Corolla 2026 ────────────────────────────────────────────────
  {
    ...
    wheels: [
      { id: "sport-18", name: 'Jantes Sport 18"', size: "18 pouces" },
    ],
    interiors: [
  ...
  // ── 13. Toyota Kijang ──────────────────────────────────────────────────────
  {
    ...
    imageUrl: "/images/vehicles/kijang.jpg",
    images: [
      "/images/vehicles/kijang.jpg",
      "/images/vehicles/kijang.jpg",
    ],
...
export function getRecommendations(preferences: UserPreferences, limit = 3): Vehicle[] {
  ...
  const scored: Score[] = VEHICLES_DATA.map((v) => {
    ...
    if (preferences.usage) {
      const usageMap: Record<string, string[]> = {
        family: ["SUV Familial", "SUV 7 places", "Berline Confort", "Compacte Hybride", "Monospace Familial", "Van Premium"],
        ...
        eco: ["Éco/Tech", "Citadine", "Compacte Hybride", "SUV Familial", "Monospace Familial"],
      };
      if ((usageMap[preferences.usage] ?? []).includes(v.category)) score += 25;
    }
    if (preferences.fuelType && preferences.fuelType !== "no-preference") {
      const et = v.specs.engineType.toLowerCase();
      const match =
        (preferences.fuelType === "hybrid" && (et === "hybride" || et === "phev")) ||
        (preferences.fuelType === "petrol" && et === "essence") ||
        (preferences.fuelType === "diesel" && et === "diesel");
      score += match ? 20 : 0;
    }
    if (preferences.priority) {
      if (preferences.priority === "comfort" && ["Berline Confort","SUV 7 places","SUV Familial","Van Premium","Monospace Familial"].includes(v.category)) score += 15;
  ...
  return scored.sort((a, b) => b.score - a.score).slice(0, limit).map((s) => s.vehicle);
}